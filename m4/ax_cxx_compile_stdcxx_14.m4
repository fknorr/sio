...
#   warranty.
#
#   This file is a modified version of the AX_CXX_COMPILE_STDCXX_11 feature
#   provided by the authors listed above.
...
m4_define([_AX_CXX_COMPILE_STDCXX_14_testbody], [[
  template <typename T>
    ...
    decltype(auto) d = a;
    auto l = [](){};
    auto m = [d=2](auto n) { return n/d; };

    auto e() { return m(3.14); }
    [[noreturn]] void die() { throw 0b101010; }
]])
